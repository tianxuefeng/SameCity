...
#define MS_Test_PublishID        @"m5qbSPQPFoGojK7BHA"
#define MS_Test_SlotToken_Banner @"6OnoO4d/ZfLb/92ybwyK1WTO"//横幅广告位
#define MS_Test_SlotToken_Poster @"TE1MnyPbwVZ/WGoWy9+XccBr"//全屏广告位
#define MS_Test_SlotToken_Splash @"IiMi8U21rzgRNRd4pcdAH64G"//开屏广告位
